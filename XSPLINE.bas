...
'XSPLINE works like SPLINE but with different input order: XSPLINE(year, yearrange, valuerange) then gives value. Same order as XLOOKUP
'SPLINE find on web. Unknown origin.
